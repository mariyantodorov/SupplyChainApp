...
contract SupplyChain {
    ...
    mapping(uint32 => uint32[]) public productTrack; // ownership by Product ID (product_id) / movement track for a product
    ...
    //Following course code. Code can be improved
    function newOwner(
        uint32 _user1Id,
        uint32 _user2Id,
        uint32 _prodId
    ...
    //not very secure, just for testing purposes
